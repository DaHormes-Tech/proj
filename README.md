...
Welcome to the University EdTech Platform, an innovative web application designed to streamline course management, material distribution, and exam preparation for University students. This platform allows admins to upload course materials (PDFs) and exam questions (via Excel or manual input), while students can access courses and take exams seamlessly.
